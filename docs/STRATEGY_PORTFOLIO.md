...
|---|---|---|---|---|---|---|
| 1 | **RSI2 buy-the-dip** (Robinhood) | Equities (10 ETFs + top-50 S&P100 large-caps) | **LIVE-READY** | IS 1.42 (thr5) / OOS 1.47 walk-fwd (n=1321); 1.36 @5bps, 1.26 @10bps · SPY IS 2.00 / OOS 2.04 | ~$700 Robinhood, fractional, $0 comm (laptop-executed; VPS `equity_signals.py` feeds signals, `exec=NONE`) | **Paper-trade ≥30 days + validate the index-level `SPX>SMA200` entry gate** (fixes single-bear-year decay: 2008 PF 0.36 / 2022 0.81). Deploy sized-down (~5%/name) as a *satellite*, never the whole book. |
