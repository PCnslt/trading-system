...
| 2 | **Index Donchian + RSI2-LONG + RSI2PT (A/B)** (MES/MNQ) | Index futures | **LIVE-PAPER** | Donchian IS 1.56 / OOS 1.52 (1.43 @3t) · RSI2-LONG IS 1.99 / OOS 2.57 (1.88 @3t) · RSI2PT (0.5% take-profit) 26y: 89% win, PF 1.92, maxDD mixed vs baseline | $350k paper fwd-test sleeve (`live.py`, IBKR paper, **Gate 5 session 1/10 starts Mon 2026-08-17**) | **Gate 5 (10 RTH sessions) → Gate 6 shadow → Gate 7 micro-live.** RSI2PT = A/B variant: same RSI2<10 entry, exits at a broker-side +0.5% limit target instead of RSI2>70/5d — forward-testing which exit wins. |
...
| 33 | **2-3 day short-term reversal (LONG-only)** | Index futures (ES/NQ/YM) | **PROMOTE-CANDIDATE** (2026-08-19) | N=2 @1t: ES PF 1.54 (OOS 1.63) · NQ 1.62 (OOS 1.70) · YM 1.26 (OOS 1.19) · win 71–76% · hold 3.4d · survives 3-tick (1.44/1.58/1.21) | Buy an N-day drop >1×ATR (N=2 best), 2×ATR stop, exit on revert-to-entry or 3d time stop. **Independent from RSI2** (daily-P&L corr +0.07–0.14, 19–21% entry overlap — not redundant). Trades ~2.5× more than RSI2, holds shorter (3.4d vs 5d), lower ES maxDD ($29k vs $43k). Same regime character as RSI2 (wins V-bounces, loses 2001-02/2012/2018/2022 grinds). RTY fails (thin 2017+ history). **Next: forward-test on MES/MNQ paper alongside RSI2.** `research/short_horizon_edges_study.py` + `short_horizon_deepdive.py`. |
