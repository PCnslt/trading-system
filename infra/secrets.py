...
CLI (used by infra/ibgateway-login.sh):
  python3 infra/secrets.py --ibkr-shell   # `export IBG_USERNAME=...` lines (SSM→file)
  python3 infra/secrets.py --json         # full resolved dict as JSON
  python3 infra/secrets.py                # human-readable status
"""
import os
