...
- **Crypto**: intraday momentum/weekend/news/sentiment/events = no edge. **NEW 2026-09-10: daily time-series momentum long/flat = REAL trend filter** (7/14/28d lookback: t=3.1–3.4, ann 48–59%, maxDD −52% vs equal-weight B&H −82%; long/short weak, only 28d t=2.25 → long-biased TIMING not market-neutral alpha). 13-sym survivorship caveat; re-run on full 202 universe when backfill lands. `research/atomics/crypto_momentum_test.py`.
