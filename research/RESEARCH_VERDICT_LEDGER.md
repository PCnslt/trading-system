...
- **Crypto**: intraday momentum/weekend/news/sentiment/events = no edge. **Daily TS-momentum = SURVIVORSHIP-BIAS ARTIFACT (corrected 2026-09-10)**: 13 liquid coins showed long/flat t=3.1–3.4, but the full 190-symbol universe collapses it to t=1.2–1.9 (28d t=1.89) and long/short turns NEGATIVE (7d t=−2.18). **Cross-sectional momentum strongly INVERTS** (14d top5 −67.7bp/d t=−5.55; 28d top10 −44.8bp/d t=−4.73) → crypto winners mean-revert; the buy-losers side is illiquid/falling-knife (same liquidity-premium trap as equities). **Short-term reversal (buy losers) ALSO DEAD** — naive t=7.4, today's-liquid t≈3.0, but POINT-IN-TIME trailing-30d-volume filter collapses it to t≈1.0 with maxDD −90%+ (lookahead + liquidity artifact). `research/atomics/crypto_momentum_full_universe.py`, `crypto_reversal_ptliquid.py`.
